...
typedef enum {
    ...
    RAYLIB_LOG_LEVEL_ERROR,          // Error logging, used on unrecoverable failures
...
RLAPI void TraceLog(int logLevel, const char *text, ...);         // Show trace log messages (RAYLIB_LOG_LEVEL_DEBUG, RAYLIB_LOG_LEVEL_INFO, RAYLIB_LOG_LEVEL_WARNING, RAYLIB_LOG_LEVEL_ERROR...)
