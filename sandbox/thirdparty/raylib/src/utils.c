...
*       NOTE: By default RAYLIB_LOG_LEVEL_DEBUG traces not shown
*
*
*   LICENSE: zlib/libpng
*
...
//----------------------------------------------------------------------------------
static int logTypeLevel = RAYLIB_LOG_LEVEL_INFO;                 // Minimum log type level
...
// Show trace log messages (RAYLIB_LOG_LEVEL_INFO, RAYLIB_LOG_LEVEL_WARNING, RAYLIB_LOG_LEVEL_ERROR, RAYLIB_LOG_LEVEL_DEBUG)
void TraceLog(int logType, const char *text, ...)
{
    ...
    switch (logType)
    {
        case RAYLIB_LOG_LEVEL_TRACE: __android_log_vprint(ANDROID_LOG_VERBOSE, "raylib", text, args); break;
        case RAYLIB_LOG_LEVEL_DEBUG: __android_log_vprint(ANDROID_RAYLIB_LOG_LEVEL_DEBUG, "raylib", text, args); break;
        case RAYLIB_LOG_LEVEL_INFO: __android_log_vprint(ANDROID_RAYLIB_LOG_LEVEL_INFO, "raylib", text, args); break;
        case RAYLIB_LOG_LEVEL_WARNING: __android_log_vprint(ANDROID_LOG_WARN, "raylib", text, args); break;
        case RAYLIB_LOG_LEVEL_ERROR: __android_log_vprint(ANDROID_RAYLIB_LOG_LEVEL_ERROR, "raylib", text, args); break;
    ...
    switch (logType)
    {
        case RAYLIB_LOG_LEVEL_TRACE: strcpy(buffer, "TRACE: "); break;
        case RAYLIB_LOG_LEVEL_DEBUG: strcpy(buffer, "DEBUG: "); break;
        case RAYLIB_LOG_LEVEL_INFO: strcpy(buffer, "INFO: "); break;
        case RAYLIB_LOG_LEVEL_WARNING: strcpy(buffer, "WARNING: "); break;
        case RAYLIB_LOG_LEVEL_ERROR: strcpy(buffer, "ERROR: "); break;
...
#else
    TRACELOG(RAYLIB_LOG_LEVEL_WARNING, "FILEIO: Standard file io not supported, use custom file callback");
#endif
    }
...
bool ExportDataAsCode(const unsigned char *data, unsigned int size, const char *fileName)
{
    ...
    if (success != 0) TRACELOG(RAYLIB_LOG_LEVEL_INFO, "FILEIO: [%s] Data as code exported successfully", fileName);
    else TRACELOG(RAYLIB_LOG_LEVEL_WARNING, "FILEIO: [%s] Failed to export data as code", fileName);
    ...
    if (fileName != NULL)
    {
        ...
        if (file != NULL)
        {
            ...
            if (size > 0)
            {
                ...
                TRACELOG(RAYLIB_LOG_LEVEL_INFO, "FILEIO: [%s] Text file loaded successfully", fileName);
            }
            else TRACELOG(RAYLIB_LOG_LEVEL_WARNING, "FILEIO: [%s] Failed to read text file", fileName);
...
static int android_write(void *cookie, const char *buf, int size)
{
    TRACELOG(RAYLIB_LOG_LEVEL_WARNING, "ANDROID: Failed to provide write access to APK");
